...
class TestSgsMaskSemantics:
    ...
    mask != 0 — a mask value like 2 is counted as simulate in Python but
    silently skipped by C++. Reject non-binary masks loudly.
    """
    ...
    def test_non_binary_mask_raises(self):
        ...
        bad_mask[1] = 2  # non-binary value — C++ would silently skip
