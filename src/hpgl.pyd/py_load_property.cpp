...
namespace hpgl
{
	...
	py_byte_property_array_t load_ind_property(const std::string & filename, int undefined_value, py::list ind_values)
	{
	...
	py_byte_property_array_t load_gslib_ind_property(const std::string & filename, int undefined_value, py::list ind_values, int i_size, int j_size, int k_size)
	{
		py_byte_property_array_t result;
		result.m_byte_property_array.reset(new property_array_t<indicator_value_t>(0));
